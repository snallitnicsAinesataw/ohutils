...
_MAP = {
    ...
    10: ('oh_blog_collection_v1', '''bid INTEGER NOT NULL, uid INTEGER, name TEXT NOT NULL, sort_order INTEGER, 
        PRIMARY KEY (name, bid)''', '(name, bid)'),
    11: ('oh_video_collection_v1', '''vid INTEGER NOT NULL, uid INTEGER, name TEXT NOT NULL, sort_order INTEGER, 
        PRIMARY KEY (name, vid)''', '(name, vid)'),
    12: ('oh_seiga_collection_v1', '''sid INTEGER NOT NULL, uid INTEGER, name TEXT NOT NULL, sort_order INTEGER, 
